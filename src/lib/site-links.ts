export const siteLinks = {
  ...
  fastifyExample:
    "https://github.com/CeibaLabs/ceiba-examples/tree/dev/fastify-proof",
  programmaticKeysExample:
    "https://github.com/CeibaLabs/ceiba-examples/blob/dev/express-proof/scripts/programmatic-keys.mjs",
} as const;
